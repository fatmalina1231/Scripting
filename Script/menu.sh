...
do
	...
	case $REPLY in
			...
			10) echo "1- Introduce file for real time graphics"
				...
				gnuplot -e "set terminal pngcairo enhanced font 'arial,10' fontscale 1.0 size 600, 400; set output '/home/Fatma/Desktop/out.png'; set style data histogram; set style fill solid border -1; plot for [i=9:10] '/dev/stdin' using i:xtic(12) title col" < ${FICHIER} ;;
				esac
				;;
			11) neofetch ;;
